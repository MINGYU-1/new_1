...
class Model1(nn.Module):
    def __init__(self,x_dim,x2_dim,c_dim,c2_dim,z_dim, h1=32, h2=64): #z1_dim은 다른 encoder에서 넣은값
    ...
    def forward(self,x,x2, c,c2):
        ...
        ## z2_mu,z2_logvar을 활용
        h2 = self.encoder2(torch.cat([x2,c2],dim = 1))
        ...
        return bce_logit , x_hat, z_mu,z_logvar
