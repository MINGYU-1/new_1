...
for seed in np.random.randint(1, 100, size=20):
    ...
    schedules = {
        "R2_Constant":1,
        "R2_Linear": gamma_linear(800, 1, 200),
        "R2_Sigmoid": gamma_sigmoid(800, 1, 300, 0.3),
        "R2_Cyclical": gamma_cyclical(800, 1, 120, 0.5)
    }
...
# 결과 저장
with open("./results_Kl_Annealing_all_1.json", "w", encoding="utf-8") as f:
